  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button id='pdfr5' type="button" class="btn btn-danger" onclick="reporte5('pdf')" name="button"><i class="fas fa-file-pdf fa-2x"></i></button>
      </div>
    </div>
  </div>
</div>
...
function reporte5(type){
  ...
  return false;
           ...
           $("#option-type-r5").on('change', function (){
             var x = $('#option-type-r5').val();
             if(x==0){
               $('#pdfr5').prop('disabled', true);
             }else{
               $('#pdfr5').prop('disabled',false);
             }
          });
</script>
