<table>
    ...
    <tbody>
        <tr>
          ...
          <td colspan="4"><strong>Reporte del alcance de las publicaciones realizadas en un año</strong> </td>
        </tr>
    </tbody>
</table>
...
<table >
  <thead>
    ...
    <tr>
      ...
      <th><strong>Vistas</strong></th>
      <th><strong>No vistas</strong></th>
    ...
    @foreach ($publicaciones as $publicacion)
       <tr>
        <td style="color: white;">&nbsp;</td>  <td style="color: white;">&nbsp;</td>   <td style="color: white;">&nbsp;</td>
         ...
         <td>{{strval($publicacion->empleados()->wherePivot('seen','=','1')->count())}}</td>
         <td>{{strval($publicacion->empleados()->wherePivot('seen','=','0')->count())}}</td>
